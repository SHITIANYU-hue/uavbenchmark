...
| 特定任务模版 | STEP 5 具体 JD 值 | `artifact_type: task_instance` |

真实 Fixture/Harness、SUT、GT/Trace、Grader 未接页面。操作见 [config_agent_quickstart.md](config_agent_quickstart.md)。
...
| `task_instance.schema.json` | `task_instance` | **产品 STEP 5「特定任务模版」**（Seed 具体 JD 值） |
